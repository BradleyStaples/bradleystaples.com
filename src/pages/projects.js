...
const ProjectsPage = () => {
  return (
    <Page title='Projects | Bradley Staples' h2='Projects'>
      ...
      <p><Link to='/resizive'>Project Link</Link></p>
      <hr />
      ...
      <p><Link to='/remember-the-ginger'>Project Link</Link></p>
      <hr />
      <h3>Minesweeper</h3>
      ...
      <p><Link to='/minesweeper'>Project Link</Link></p>
      <hr />
      <h3>Randle</h3>
      ...
      <p><Link to='/randle'>Project Link</Link></p>
      <hr />
      <h3>Fontbeast</h3>
      ...
      <p><Link to='/fontbeast'>Project Link</Link></p>
    </Page>
  )
}

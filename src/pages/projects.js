...
const ProjectsPage = () => {
  return (
    <Page title='Projects | Bradley Staples' h2='Projects'>
      ...
      <p>A fun, fast card game of 'concentration' more commonly known as Match or Memory, simply flip cards over to match them with their twin until you have matched all the cards. The game remembers how many flips it takes you to complete the game. It also monitors time to complete the game to give you a few simple metrics to compare against yourself or others.</p>
      <p><a href='https://remember-the-ginger.bradleystaples.com'>Project Link</a></p>
      <hr />
      <h3>Minesweeper</h3>
      <p>A simple game that lets you flag mines, show empty squares, keeps score and even cheat, if you're so inclined. In addition, you can save and load your game later.</p>
